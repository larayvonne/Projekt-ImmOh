...
<head>
  ...
  <link rel="stylesheet" href="../css/cssGamemenu.css">
...
<body>
  ...
  <main>
    ...
    <div class="headline">
      <h1 class="replace-text-primary">Spielen für den Planeten – Ein Baum pro Spiel! </h1>
      <p>Jedes Minigame zählt: Für jedes Spiel, das du spielst, pflanzen wir einen Baum.
        So wird aus deinem Spielspaß ein Beitrag für die Umwelt.
        Zocke mit gutem Gewissen – spiel dich grün! </p>
      <br>
    </div>
    <div class="box">
      ...
      <div class="section reverse">
        <div class="text">
          <h2> Weg mit den Dreck</h2>
          <p>Schaffst du es in 10 Sekunden den gesammten Müll aufzusammeln und somit ein Teil für einen saubere Natur zu schaffen? </p>
      ...
      <div class="section">
        <div class="text">
          <h2>Klima Memory</h2>
          <p>Mama Affe hat Baby Affe verloren, schaffst du es die beiden wieder zu vereinen? </p>
        </div>
        <div class="image">
      ...
      <div class="section reverse">
        <div class="text">
          <h2>Tic-Tac-Toe </h2>
          <p>Schaffst du es gegen mich zu gewinnen und nebenbei etwas Gutes für die Umwelt zu leisten? </p>
        </div>
        <div class="image">
    ...
    <div class="end">
      <h2>Jetzt Voranmelden und nachhaltig Wohnen </h2>
