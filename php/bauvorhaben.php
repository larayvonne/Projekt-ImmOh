    ...
    <div class="box">
      <div class="section reverse">
        <div class="text">
          ...
          <button class="addToCart button" data-id="5" data-name="Bauvorhaben Simmering">Jetzt Anteile kaufen</button>
        </div>
        <div class="image">
      ...
      <div class="section">
        <div class="text">
          ...
          <button class="addToCart button" data-id="6" data-name="Bauvorhaben Gutenberg">Jetzt Anteile kaufen</button>
        </div>
        <div class="image">
      ...
      <div class="section reverse">
        <div class="text">
          ...
          <button class="addToCart button" data-id="7" data-name="Bauvorhaben Mödling">Jetzt Anteile kaufen</button>
        </div>
        <div class="image">
